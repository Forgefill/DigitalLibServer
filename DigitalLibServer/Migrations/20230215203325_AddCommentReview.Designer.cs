...
namespace DigitalLibServer.Migrations
{
    ...
    [Migration("20230215203325_AddCommentReview")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DigitalLibServer.Model.Entities.Comment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("NUMBER(10)");
            ...
            modelBuilder.Entity("DigitalLibServer.Model.Entities.Review", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("NUMBER(10)");
            ...
            modelBuilder.Entity("DigitalLibServer.Model.Entities.Comment", b =>
                {
                    b.HasOne("DigitalLibServer.Model.Entities.Chapter", "Chapter")
                        .WithMany("Comments")
                        .HasForeignKey("ChapterId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DigitalLibServer.Model.Entities.User", "User")
                        .WithMany("Comments")
